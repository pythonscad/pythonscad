...
## [0.6.0](https://github.com/pythonscad/pythonscad/compare/pythonscad-v0.8.0...pythonscad-v0.6.0) (2025-12-31)
...
* add comprehensive versioning and contribution documentation ([f4fd1bb](https://github.com/pythonscad/pythonscad/commit/f4fd1bb4d86f538d2d4e027a2d64115cd23071a4))
* Document operators `&`, `|` and `-` between two objects ([47c12e7](https://github.com/pythonscad/pythonscad/commit/47c12e7e25e4b3a03a5f5ffbfbc1d4c19b948f80))
* Document operators `&`, `|` and `-` between two objects ([beda080](https://github.com/pythonscad/pythonscad/commit/beda0808da600a01dbce9b2e4be8f8e60d5e013c))
