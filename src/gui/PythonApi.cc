...
PythonApi::PythonApi(ScintillaEditor *editor, QsciLexer *lexer) : QsciAbstractAPIs(lexer), editor(editor)
{
...
void PythonApi::autoCompleteFolder(const QStringList& context, const QString& text, const int col,
                                   QStringList& list)
{
...
void PythonApi::correctUserVarNamesForCompletionFromSourceFile(const SourceFile *sourceFile,
...
void PythonApi::correctUserVarNamesForCompletionFromInputText(bool flagAutoCompleteIncludeVariables,
                                                              bool flagAutoCompleteIncludeModules,
                                                              bool flagAutoCompleteIncludeFunctions)
{
