...
enum { LANG_NONE = -1, LANG_SCAD = 0, LANG_PYTHON = 1, LANG_JS = 2, LANG_LUA = 3 , LANG_NUM = 4};
...
public:
  ...
  const char *suffix;
  int (*check_validfile)(const char *filename, const char *content); // check if filename and content is correct
};

extern LanguageDesc *languageDesc[LANG_NUM];
