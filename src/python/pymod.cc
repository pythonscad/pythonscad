...
int pythonRunArgs(int, char **) { return 1; }
int pythonCreateVenv(const std::string&) { return 1; }
int pythonRunModule(const std::string&, const std::string&, const std::vector<std::string>&) { return 1; }
#else
