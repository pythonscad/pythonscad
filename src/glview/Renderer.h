...
public:
  ...
  virtual void prepare(const Vector3d &viewdir, const ShaderUtils::ShaderInfo *shaderinfo) = 0;
  virtual void draw(bool showedges, const Vector3d &viewdir, const ShaderUtils::ShaderInfo *shaderinfo) const = 0;
