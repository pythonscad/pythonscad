...
export PYTHONPATH="\${HERE}/usr/share/pythonscad/libraries/python:\${HERE}/usr/lib/python${PYTHON_VERSION}:\${HERE}/usr/lib/python${PYTHON_VERSION}/site-packages:\${PYTHONPATH}"
