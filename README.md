...
You can create an issue to plan and discuss your change by visiting https://github.com/pythonscad/pythonscad/issues.
...
We support building PythonSCAD headless for WebAssembly w/ Emscripten, using a premade Docker image built in [openscad/openscad-wasm](https://github.com/openscad/openscad-wasm) (which also has usage examples)
