...
# Position the text
# We need to move the text into the center of the plate
# and slightly above the bottom surface to avoid rendering artifacts (z-fighting)
...
# Since the GCode generated for the laser cutter does
# not utilize depth (z), offset the engraved portions
# so that it is not masked by the cut parts, but it will
# be rendered flat on the plane.
